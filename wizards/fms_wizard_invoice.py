...
class FmsWizardInvoice(models.TransientModel):
    ...
    @api.model
    def compute_order(self, record, lines):
        res = {}
    ...
    def make_invoices(self):
        ...
        for record in records:
            ...
            journal_id = record.company_id.sale_journal_id.id
            if active_model == 'orders':
                res = self.compute_order(record, lines)
